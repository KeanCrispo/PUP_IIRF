...
```bash
git remote add encore encore://face-recognition-system-5idi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/face-recognition-system-5idi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/face-recognition-system-5idi/settings/integrations/github)
